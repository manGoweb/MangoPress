...
class ExampleMetabox extends React.Component {
	...
	render() {
		const { name, value, message, hide_data } = this.props
		...
		return (
			<div>
				...
				{!!Object.keys(this.props).length && <pre style={{ whiteSpace: "pre-wrap", fontSize: 10, lineHeight: 1.1 }}>
				...
				{name && (
					<div>
						...
						<input
							style={{ width: "100%" }}
							type="text"
							name={`ac-callback[ac_customCallback]`}
						/>
					</div>
				)}
			</div>
